...
async function initializeBillsTable() {
    var requestOptions = {
     ...
     fetch("http://127.0.0.1:4523/m1/5398300-5071939-default/bill/getAllData", requestOptions)
        .then(response => response.text())
        .then(result => console.log(result))
        .catch(error => console.log('error', error));
          // 使用 fetch 获取数据
          const response = await fetch("http://127.0.0.1:4523/m1/5398300-5071939-default/bill/getAllData");
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (confirm(`确定要删除账单 ID: ${billId} 吗？`)) {
                ...
                // 发送删除请求
                fetch("http://127.0.0.1:4523/m1/5398300-5071939-default/bill/delete", requestOptions)
